...
Create a local API key to authenticate your tools with the proxy. This is **not** a user account - it's simply a key for your own personal use to access your own accounts through the proxy.
